...
public class Login2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.createacc ) {
            Intent intent = new Intent(Login2Activity.this, Finder_Registration_Activity.class);
            startActivity(intent);
            finish();
        }
        if (v.getId() == R.id.loginb) {
            fAuth.signOut();
          //  Toast.makeText(Login2Activity.this,"hello",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Login2Activity.this,"Processing...",Toast.LENGTH_SHORT).show();
                    ...
                    if (task.isSuccessful()) {
                     ...
                     databaseReference.child(okMail).addListenerForSingleValueEvent(new ValueEventListener() {
                         ...
                         public void onDataChange(@NonNull DataSnapshot snapshot) {
                                 ...
                                 if(status1.getStatus().equals("finder"))
                                 {
                                     startActivity(new Intent(Login2Activity.this, FinderHomeActivity.class));
                                     finish();
                                 }
                                 else {
                                     Toast.makeText(Login2Activity.this, "Error!" + task.getException(), Toast.LENGTH_SHORT).show();
                                 }
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(Login2Activity.this,"Reset link has been sent to email",Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Login2Activity.this,"Reset link not sent\nError: "+e.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
