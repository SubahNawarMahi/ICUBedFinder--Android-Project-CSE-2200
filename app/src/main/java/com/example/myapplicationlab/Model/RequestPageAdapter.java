...
public class RequestPageAdapter extends RecyclerView.Adapter<RequestPageAdapter.MyViewHolder> {
    ...
    DatabaseReference databaseReference3 = FirebaseDatabase.getInstance().getReference("allRequest");

    public RequestPageAdapter(List<RequestModel> requestModelList, Context context) {
    ...
    @NonNull
    @Override
    public RequestPageAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.finder_request_page_layout,parent,false);
        return new RequestPageAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RequestPageAdapter.MyViewHolder holder, int position) {

        RequestPageAdapter.MyViewHolder holders = holder;

        RequestModel requestModel = requestModelList.get(position);


        holders.hosName.setText("Hospital: "+requestModel.getHosName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        TextView hosName,bedType,noOfBed,status,price;
        ...
        public void onClick(View v) {
            ...
            if(v.getId() == R.id.cancel)
            {
                ...
                databaseReference3.child(uid).child(key).setValue(requestModel1);
            ...
            {
                Toast.makeText(context,"Contact with authority for payment",Toast.LENGTH_SHORT).show();
            }
